          ...
          <div className="relative max-w-lg w-full max-h-[90vh] overflow-y-auto rounded-2xl" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="glass-panel p-6 rounded-2xl border border-white/10 space-y-4">
              ...
              <div className="flex rounded-xl bg-black/30 p-1">
                <button
                  type="button"
                  onClick={() => setPosterMode('standard')}
                ...
                <button
                  ...
                  className={`flex-1 py-2 text-sm rounded-lg transition-all ${
                    posterMode === 'ai'
                      ? 'bg-gradient-to-r from-purple-500/20 to-blue-500/20 text-purple-300 font-semibold'
                      : 'text-white/50 hover:text-white/80'
                  }`}
                >
              ...
              {posterMode === 'ai' && (
                <div className="space-y-2">
                  <label className="text-sm text-secondary">选择海报风格</label>
                  <div className="grid grid-cols-3 gap-2">
                    {AI_POSTER_STYLES.map((s) => (
                      <button
                        key={s.key}
                        type="button"
